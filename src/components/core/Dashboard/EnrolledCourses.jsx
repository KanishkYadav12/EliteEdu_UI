  ...
  useEffect(() => {
    ;(async () => {
      try {
        ...
        const filterPublishCourse =
          res?.filter((ele) => ele.status !== "Draft") || []
          ...
          {enrolledCourses?.map((course, i, arr) => (
            ...
            >
              <div
                ...
                onClick={() => {
                  // ✅ FIXED: Check if courseContent exists and has items before navigating
                  if (
                    ...
                    // If no content, just go to course details
